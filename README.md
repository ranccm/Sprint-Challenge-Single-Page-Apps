...
> Answer: server side routing needs to keep making requests to the server in order for the page to rerender. alternatively client-side routing loads the whole page initially.
